...
```{r residOaks, cache = TRUE, warning = FALSE, eval = FALSE}
...
```{r residQuartz, cache = TRUE, warning = FALSE, eval = FALSE}
...
```{r residK, cache = TRUE, warning = FALSE, eval = FALSE}
...
```{r residIsotope, cache = TRUE, warning = FALSE, eval = FALSE}
...
```{r residTic, cache = TRUE, warning = FALSE, eval = FALSE}
...
```{r residToc, cache = TRUE, warning = FALSE, eval = FALSE}
